...
export class FormularioComponent implements OnInit {
  ...
  // correspondiente a la propiedad que se acaba de definir (Los servicios se inyectan en el constructor, en angular)
  // Un servicio es siempre una instacia singleton
